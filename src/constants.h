...
constexpr uint16_t ROOM_LIST_TILE_ICON_LABEL_GAP = 16;
...
constexpr uint16_t SETTINGS_BATTERY_CARD_Y = SETTINGS_STANDBY_TILE_Y + SETTINGS_STANDBY_TILE_H + SETTINGS_TILE_GAP;
constexpr uint16_t SETTINGS_SLEEP_TILE_Y = SETTINGS_BATTERY_CARD_Y + SETTINGS_TILE_H + SETTINGS_TILE_GAP;
constexpr uint32_t SLEEP_TEST_TIMER_BACKSTOP_S = 90;
